...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:04:41+00:00",
  "source_file": "README.md",
  "language_code": "ru"
}
-->
[![Лицензия GitHub](https://img.shields.io/github/license/microsoft/Security-101)](https://github.com/microsoft/Security-101/blob/main/LICENSE)  
[![Проблемы или запросы на GitHub](https://img.shields.io/github/issues-pr/microsoft/Security-101)](https://github.com/microsoft/Security-101/pulls)  
[![Проблемы на GitHub](https://img.shields.io/github/issues/microsoft/Security-101)](https://github.com/microsoft/Security-101/issues)  
[![Звезды репозитория GitHub](https://img.shields.io/github/stars/microsoft/Security-101)](https://github.com/microsoft/Security-101/stargazers)  
[![Наблюдатели на GitHub](https://img.shields.io/github/watchers/microsoft/Security-101)](https://github.com/microsoft/Security-101/watchers)  
[![Форки на GitHub](https://img.shields.io/github/forks/microsoft/Security-101)](https://github.com/microsoft/Security-101/forks)  
...
|-------------------|-------------------------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| **1.1**           | Основные концепции безопасности           | [Триада CIA](https://github.com/microsoft/Security-101/blob/main/1.1%20The%20CIA%20triad%20and%20other%20key%20concepts.md)                        | Изучите конфиденциальность, доступность и целостность. Также аутентичность, непризнание и конфиденциальность. |
...
| **1.3**           | Основные концепции безопасности           | [Понимание управления рисками](https://github.com/microsoft/Security-101/blob/main/1.3%20Understanding%20risk%20management.md)       | Узнайте об оценке и понимании рисков – их влиянии/вероятности и реализации мер контроля.                                                                                                               | |
...
| **3.3**           | Основы сетевой безопасности               | [Возможности сетевой безопасности](https://github.com/microsoft/Security-101/blob/main/3.3%20Network%20security%20capabilities.md)        | Узнайте об инструментах сетевой безопасности – файрволы, WAF, защита от DDoS и т.д.                            |
