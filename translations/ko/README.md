...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-12T08:55:49+00:00",
...
AI 기술이 빠르게 발전하는 시대에 IT 시스템을 안전하게 보호하는 방법을 이해하는 것이 더욱 중요해졌습니다. 이 과정은 보안 학습을 시작할 수 있도록 기본적인 사이버 보안 개념을 가르치기 위해 설계되었습니다. 특정 벤더에 의존하지 않으며, 약 30~60분 정도 소요되는 짧은 강의로 나뉘어 있습니다. 각 강의에는 간단한 퀴즈와 추가 학습을 위한 링크가 포함되어 있어 주제를 더 깊이 탐구할 수 있습니다.
...
- 🔑 정체성, 네트워킹, 보안 운영, 인프라 및 데이터 보안 전반의 주요 개념과 주제 이해
...
| **8.2**           | AI 보안 기본 사항                        | [AI 보안 기능](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | AI 보안 도구와 AI를 보호하기 위해 사용할 수 있는 통제 방법에 대해 알아보기.                         |
| **8.3**           | AI 보안 기본 사항                        | [책임 있는 AI](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | 책임 있는 AI란 무엇인지와 보안 전문가가 알아야 할 AI 관련 위험에 대해 알아보기.                          |
...
AI 앱을 개발하다가 막히거나 질문이 있다면 다음을 방문하세요:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

제품 피드백을 제공하거나 개발 중 오류가 발생하면 다음을 방문하세요:
