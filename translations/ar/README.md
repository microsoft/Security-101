...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:05:48+00:00",
...
- 🔐 مفاهيم الأمن السيبراني الأساسية مثل مثلث CIA، والاختلافات بين المخاطر والتهديدات، إلخ.
...
- 🚫 كيفية "الاختراق" أو القيام بالاختبارات الهجومية.
...
في النهاية، يمكنك التفكير في اجتياز [امتحان SC-900: أساسيات الأمان والامتثال والهوية من Microsoft.](https://learn.microsoft.com/credentials/certifications/exams/sc-900/?WT.mc_id=academic-96948-sayoung)  
...
| **4.1**           | أساسيات العمليات الأمنية          | [المفاهيم الرئيسية للعمليات الأمنية](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | تعلم حول لماذا العمليات الأمنية مهمة وكيف تختلف عن فرق العمليات العادية لتكنولوجيا المعلومات.                  |
| **4.2**           | أساسيات العمليات الأمنية          | [بنية الثقة الصفرية للعمليات الأمنية](https://github.com/microsoft/Security-101/blob/main/4.2%20SecOps%20zero%20trust%20architecture.md)       | تعلم حول كيف تساهم العمليات الأمنية في بنية الثقة الصفرية الشاملة والتهديدات التي تخففها.                      |
| **4.3**           | أساسيات العمليات الأمنية          | [قدرات العمليات الأمنية](https://github.com/microsoft/Security-101/blob/main/4.3%20SecOps%20capabilities.md)                  | تعلم حول أدوات العمليات الأمنية – SIEM، XDR، إلخ.                                                                    |
| **4.4**           | [اختبار نهاية الوحدة](https://github.com/microsoft/Security-101/blob/main/4.4%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
| **5.1**           | أساسيات أمن التطبيقات         | [المفاهيم الرئيسية لأمن التطبيقات](https://github.com/microsoft/Security-101/blob/main/5.1%20AppSec%20key%20concepts.md)                  | تعلم حول مفاهيم أمن التطبيقات مثل التصميم الآمن، التحقق من المدخلات، إلخ.                                    |
...
| **6.1**           | أساسيات أمان البنية التحتية              | [المفاهيم الرئيسية لأمان البنية التحتية](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | تعرف على تعزيز الأنظمة، التحديثات، النظافة الأمنية، وأمان الحاويات.                                  |
...
| **7.1**           | أساسيات أمان البيانات                   | [المفاهيم الرئيسية لأمان البيانات](https://github.com/microsoft/Security-101/blob/main/7.1%20Data%20security%20key%20concepts.md)           | تعرف على تصنيف البيانات والاحتفاظ بها ولماذا هذا مهم للمؤسسة.                     |
...
| **8.1**           | أساسيات أمان الذكاء الاصطناعي            | [المفاهيم الرئيسية لأمان الذكاء الاصطناعي](https://github.com/microsoft/Security-101/blob/main/8.1%20AI%20security%20key%20concepts.md)          | تعرف على الفروقات والتشابهات بين الأمان التقليدي وأمان الذكاء الاصطناعي.                 |
...
| **8.3**           | أساسيات أمان الذكاء الاصطناعي            | [الذكاء الاصطناعي المسؤول](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | تعرف على ما هو الذكاء الاصطناعي المسؤول والأضرار الخاصة بالذكاء الاصطناعي التي يجب أن يكون المتخصصون في الأمان على دراية بها.                          |
