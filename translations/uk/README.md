...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:52:50+00:00",
  "source_file": "README.md",
  "language_code": "uk"
}
-->
[![Ліцензія GitHub](https://img.shields.io/github/license/microsoft/Security-101)](https://github.com/microsoft/Security-101/blob/main/LICENSE)  
[![Проблеми або Pull Requests на GitHub](https://img.shields.io/github/issues-pr/microsoft/Security-101)](https://github.com/microsoft/Security-101/pulls)  
[![Проблеми на GitHub](https://img.shields.io/github/issues/microsoft/Security-101)](https://github.com/microsoft/Security-101/issues)  
[![Зірки репозиторія GitHub](https://img.shields.io/github/stars/microsoft/Security-101)](https://github.com/microsoft/Security-101/stargazers)  
[![Спостерігачі GitHub](https://img.shields.io/github/watchers/microsoft/Security-101)](https://github.com/microsoft/Security-101/watchers)  
[![Форки GitHub](https://img.shields.io/github/forks/microsoft/Security-101)](https://github.com/microsoft/Security-101/forks)  
...
- 🔧 Приклади інструментів для впровадження контролю безпеки.
...
| **2.2**           | Основи управління ідентифікацією та доступом | [Архітектура IAM з нульовою довірою](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Дізнайтеся, як ідентифікація є новим периметром для сучасних ІТ-середовищ і які загрози вона зменшує.          |
...
| **3.3**           | Основи мережевої безпеки                 | [Можливості мережевої безпеки](https://github.com/microsoft/Security-101/blob/main/3.3%20Network%20security%20capabilities.md)        | Дізнайтеся про інструменти мережевої безпеки – міжмережеві екрани, WAF, захист від DDoS тощо.                                    |
...
| **8.2**           | Основи безпеки штучного інтелекту       | [Можливості безпеки AI](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | Дізнайтеся про інструменти безпеки AI та контролі, які можна використовувати для захисту AI.                     |
...
Якщо ви застрягли або маєте питання щодо створення AI-додатків, приєднуйтесь до обговорень з іншими учнями та досвідченими розробниками про MCP. Це підтримуюча спільнота, де питання вітаються, а знання діляться вільно.
