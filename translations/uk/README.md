...
- 🚫 Як "зламувати" або проводити атаки (червоні команди/офенсивна безпека).
...
| **2.2**           | Основи управління ідентифікацією та доступом | [Архітектура IAM з нульовою довірою](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Дізнайтеся, як ідентифікація стала новим периметром для сучасних ІТ-середовищ і які загрози вона зменшує.          |
| **2.3**           | Основи управління ідентифікацією та доступом | [Можливості IAM](https://github.com/microsoft/Security-101/blob/main/2.3%20IAM%20capabilities.md)                     | Дізнайтеся про можливості IAM і засоби контролю для захисту ідентифікації.                                                  |
...
| **8.3**           | Основи безпеки штучного інтелекту        | [Відповідальний ШІ](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | Дізнайтеся, що таке відповідальний ШІ та про специфічні ризики ШІ, про які мають знати фахівці з безпеки.                          |
...
- [Майстерність GitHub Copilot для парного програмування](https://github.com/microsoft/Mastering-GitHub-Copilot-for-Paired-Programming)
