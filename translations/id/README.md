...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:03:10+00:00",
...
[![Masalah atau Pull Request GitHub](https://img.shields.io/github/issues/microsoft/Security-101)](https://github.com/microsoft/Security-101/issues)
...
> 💁 Jika Anda memiliki masukan atau saran tentang kursus ini dan konten yang menurut Anda kurang, kami ingin mendengarnya!
...
| **2.1**           | Dasar-dasar manajemen identitas & akses | [Konsep utama IAM](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | Pelajari tentang prinsip hak akses minimal, pemisahan tugas, bagaimana IAM mendukung zero trust.               |
| **2.2**           | Dasar-dasar manajemen identitas & akses | [Arsitektur zero trust IAM](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Pelajari tentang bagaimana identitas menjadi perimeter baru untuk lingkungan TI modern dan ancaman yang dapat diatasi.          |
...
| **3.2**           | Dasar-dasar keamanan jaringan             | [Arsitektur zero trust jaringan](https://github.com/microsoft/Security-101/blob/main/3.2%20Networking%20zero%20trust%20architecture.md)   | Pelajari tentang bagaimana jaringan berkontribusi pada arsitektur ZT end-to-end dan ancaman yang dapat diatasi.                  |
...
| **4.1**           | Dasar-dasar operasi keamanan          | [Konsep utama SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | Pelajari mengapa operasi keamanan itu penting dan bagaimana ini berbeda dari tim operasi TI biasa.                  |
| **4.2**           | Dasar-dasar operasi keamanan          | [Arsitektur zero trust SecOps](https://github.com/microsoft/Security-101/blob/main/4.2%20SecOps%20zero%20trust%20architecture.md)       | Pelajari tentang bagaimana SecOps berkontribusi pada arsitektur ZT end-to-end dan ancaman yang dapat diatasi.                      |
...
| **5.1**           | Dasar-dasar keamanan aplikasi         | [Konsep utama AppSec](https://github.com/microsoft/Security-101/blob/main/5.1%20AppSec%20key%20concepts.md)                  | Pelajari tentang konsep AppSec seperti desain aman, validasi input, dll.                                    |
