...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:53:40+00:00",
...
- 🌐 Entendimento do que é confiança zero e por que isso é importante na cibersegurança moderna.
...
- 🚫 Como "hackear" ou realizar segurança ofensiva/equipe vermelha.
- 🚫 Aprender sobre padrões de conformidade específicos.
...
| **1.3**               | Conceitos básicos de segurança         | [Compreendendo a gestão de riscos](https://github.com/microsoft/Security-101/blob/main/1.3%20Understanding%20risk%20management.md)       | Aprenda sobre como avaliar e entender riscos – impacto/probabilidade e implementação de controles.               |
...
| **2.3**               | Fundamentos de gestão de identidade e acesso | [Capacidades de IAM](https://github.com/microsoft/Security-101/blob/main/2.3%20IAM%20capabilities.md)                     | Aprenda sobre as capacidades e controles de IAM para proteger identidades.                                       |
...
| **3.2**               | Fundamentos de segurança de rede       | [Arquitetura de confiança zero em redes](https://github.com/microsoft/Security-101/blob/main/3.2%20Networking%20zero%20trust%20architecture.md)   | Aprenda sobre como redes contribuem para uma arquitetura de confiança zero de ponta a ponta e as ameaças que ela mitiga. |
...
| **4.1**               | Fundamentos de operações de segurança  | [Conceitos-chave de SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | Aprenda sobre por que operações de segurança são importantes e como elas diferem de equipes normais de TI.       |
...
| **5.2**           | Fundamentos de segurança de aplicações    | [Capacidades de AppSec](https://github.com/microsoft/Security-101/blob/main/5.2%20AppSec%20key%20capabilities.md)                  | Aprenda sobre ferramentas de AppSec: ferramentas de segurança de pipeline, análise de código, varredura de segredos, etc.                       |
| **5.3**           | [Quiz de encerramento do módulo](https://github.com/microsoft/Security-101/blob/main/5.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
...
| **6.3**           | [Quiz de encerramento do módulo](https://github.com/microsoft/Security-101/blob/main/6.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
...
| **7.3**           | [Quiz de encerramento do módulo](https://github.com/microsoft/Security-101/blob/main/7.3%20End%20of%20module%20quiz.md)                        |
...
| **8.4**           | [Quiz de encerramento do módulo](https://github.com/microsoft/Security-101/blob/main/8.4%20End%20of%20module%20quiz.md)     
