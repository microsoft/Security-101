...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:01:43+00:00",
...
**Si vous souhaitez ajouter d'autres langues, la liste des langues prises en charge est disponible [ici](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
À une époque où l'adoption des technologies d'IA évolue rapidement, il est encore plus crucial de comprendre comment sécuriser les systèmes informatiques. Ce cours est conçu pour vous enseigner les concepts fondamentaux de la cybersécurité afin de démarrer votre apprentissage en sécurité. Il est indépendant des fournisseurs et divisé en petites leçons qui devraient prendre environ 30 à 60 minutes à compléter. Chaque leçon comprend un petit quiz et des liens pour approfondir le sujet si vous le souhaitez.
...
- 🔐 Concepts de base en cybersécurité tels que la triade CIA, les différences entre risques, menaces, etc.
- 🛡️ Comprendre ce qu'est un contrôle de sécurité et sous quelles formes il se présente.
- 🌐 Comprendre ce qu'est le "zero trust" et pourquoi c'est important dans la cybersécurité moderne.
...
- 🔧 Fournir des exemples d'outils utilisés pour mettre en œuvre des contrôles de sécurité.

Ce que ce cours ne couvre pas 🙅‍♂️

- 🚫 Comment utiliser des outils de sécurité spécifiques.
- 🚫 Comment "pirater" ou effectuer des tests d'intrusion/offensifs.
...
> 💁 Si vous avez des retours ou des suggestions sur ce cours ou sur des contenus manquants, nous serions ravis de vous entendre !
...
| **1.2**               | Concepts de sécurité de base           | [Menaces courantes en cybersécurité](https://github.com/microsoft/Security-101/blob/main/1.2%20Common%20cybersecurity%20threats.md)        | Découvrez les menaces courantes en cybersécurité auxquelles font face les individus et les organisations.       |
...
| **1.4**               | Concepts de sécurité de base           | [Pratiques et documentation en sécurité](https://github.com/microsoft/Security-101/blob/main/1.4%20Security%20practices%20and%20documentation.md) | Découvrez la différence entre politiques, procédures, normes et réglementations/lois.                          |
| **1.5**               | Concepts de sécurité de base           | [Zero trust](https://github.com/microsoft/Security-101/blob/main/1.5%20Zero%20trust.md)                           | Découvrez ce qu'est le "zero trust" et comment cela affecte l'architecture. Qu'est-ce que la défense en profondeur ? |
| **1.6**               | Concepts de sécurité de base           | [Le modèle de responsabilité partagée](https://github.com/microsoft/Security-101/blob/main/1.6%20Shared%20responsibility%20model.md)                           | Qu'est-ce que le modèle de responsabilité partagée et comment affecte-t-il la cybersécurité ?                   |
| **1.7**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/1.7%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **2.1**               | Fondamentaux de la gestion des identités et des accès | [Concepts clés IAM](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | Découvrez le principe du moindre privilège, la séparation des tâches, et comment IAM soutient le "zero trust". |
| **2.2**               | Fondamentaux de la gestion des identités et des accès | [Architecture IAM zero trust](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Découvrez comment l'identité est le nouveau périmètre pour les environnements informatiques modernes et les menaces qu'elle atténue. |
| **2.3**               | Fondamentaux de la gestion des identités et des accès | [Capacités IAM](https://github.com/microsoft/Security-101/blob/main/2.3%20IAM%20capabilities.md)                     | Découvrez les capacités et contrôles IAM pour sécuriser les identités.                                         |
| **2.4**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/2.4%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **3.1**               | Fondamentaux de la sécurité réseau     | [Concepts clés du réseau](https://github.com/microsoft/Security-101/blob/main/3.1%20Networking%20key%20concepts.md)              | Découvrez les concepts de réseau (adresses IP, numéros de port, cryptage, etc.).                                |
| **3.2**               | Fondamentaux de la sécurité réseau     | [Architecture réseau zero trust](https://github.com/microsoft/Security-101/blob/main/3.2%20Networking%20zero%20trust%20architecture.md)   | Découvrez comment le réseau contribue à une architecture ZT de bout en bout et les menaces qu'il atténue.      |
| **3.3**               | Fondamentaux de la sécurité réseau     | [Capacités de sécurité réseau](https://github.com/microsoft/Security-101/blob/main/3.3%20Network%20security%20capabilities.md)        | Découvrez les outils de sécurité réseau – pare-feu, WAF, protection DDoS, etc.                                 |
| **3.4**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/3.4%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **4.1**               | Fondamentaux des opérations de sécurité | [Concepts clés SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | Découvrez pourquoi les opérations de sécurité sont importantes et en quoi elles diffèrent des équipes IT classiques. |
| **4.2**               | Fondamentaux des opérations de sécurité | [Architecture SecOps zero trust](https://github.com/microsoft/Security-101/blob/main/4.2%20SecOps%20zero%20trust%20architecture.md)       | Découvrez comment SecOps contribue à une architecture ZT de bout en bout et les menaces qu'il atténue.         |
| **4.3**               | Fondamentaux des opérations de sécurité | [Capacités SecOps](https://github.com/microsoft/Security-101/blob/main/4.3%20SecOps%20capabilities.md)                  | Découvrez les outils SecOps – SIEM, XDR, etc.                                                                  |
| **4.4**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/4.4%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **5.1**               | Fondamentaux de la sécurité des applications | [Concepts clés AppSec](https://github.com/microsoft/Security-101/blob/main/5.1%20AppSec%20key%20concepts.md)                  | Découvrez les concepts AppSec tels que la sécurité par conception, la validation des entrées, etc.             |
...
Si vous êtes bloqué ou avez des questions sur la création d'applications IA, rejoignez d'autres apprenants et développeurs expérimentés dans des discussions sur MCP. C'est une communauté solidaire où les questions sont les bienvenues et le partage de connaissances est encouragé.
