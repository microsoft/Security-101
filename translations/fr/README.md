...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T18:09:50+00:00",
...
Dans cette époque de changement rapide et d'adoption des technologies d'IA, il est encore plus crucial de comprendre comment sécuriser les systèmes informatiques. Ce cours est conçu pour vous enseigner les concepts fondamentaux de la cybersécurité afin de démarrer votre apprentissage en sécurité. Il est indépendant des fournisseurs et divisé en petites leçons qui devraient prendre environ 30 à 60 minutes à compléter. Chaque leçon inclut un petit quiz et des liens pour approfondir le sujet si vous souhaitez en savoir plus.
...
> 💁 Si vous avez des commentaires ou des suggestions sur ce cours ou sur des contenus qui manquent, nous serions ravis de vous entendre !
...
| **1.4**               | Concepts de sécurité de base           | [Pratiques et documentation en sécurité](https://github.com/microsoft/Security-101/blob/main/1.4%20Security%20practices%20and%20documentation.md) | Apprenez la différence entre les politiques, les procédures, les normes et les réglementations/lois.           |
...
| **3.2**               | Fondamentaux de la sécurité réseau     | [Architecture réseau zéro confiance](https://github.com/microsoft/Security-101/blob/main/3.2%20Networking%20zero%20trust%20architecture.md)   | Apprenez comment le réseau contribue à une architecture zéro confiance de bout en bout et les menaces qu'il atténue. |
...
| **4.2**               | Fondamentaux des opérations de sécurité | [Architecture SecOps zéro confiance](https://github.com/microsoft/Security-101/blob/main/4.2%20SecOps%20zero%20trust%20architecture.md)       | Apprenez comment SecOps contribue à une architecture zéro confiance de bout en bout et les menaces qu'il atténue. |
...
| **5.2**               | Fondamentaux de la sécurité des applications | [Capacités AppSec](https://github.com/microsoft/Security-101/blob/main/5.2%20AppSec%20key%20capabilities.md)                  | Apprenez les outils AppSec : outils de sécurité de pipeline, analyse de code, analyse de secrets, etc.          |
| **5.3**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/5.3%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **6.1**               | Fondamentaux de la sécurité de l'infrastructure | [Concepts clés de la sécurité de l'infrastructure](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | Apprenez à renforcer les systèmes, appliquer des correctifs, maintenir une hygiène de sécurité, sécuriser les conteneurs. |
| **6.2**               | Fondamentaux de la sécurité de l'infrastructure | [Capacités de sécurité de l'infrastructure](https://github.com/microsoft/Security-101/blob/main/6.2%20Infrastructure%20security%20capabilities.md) | Apprenez les outils qui peuvent aider à sécuriser l'infrastructure, par exemple CSPM, sécurité des conteneurs, etc. |
| **6.3**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/6.3%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **7.1**               | Fondamentaux de la sécurité des données | [Concepts clés de la sécurité des données](https://github.com/microsoft/Security-101/blob/main/7.1%20Data%20security%20key%20concepts.md)           | Apprenez la classification et la conservation des données et pourquoi cela est important pour une organisation. |
| **7.2**               | Fondamentaux de la sécurité des données | [Capacités de sécurité des données](https://github.com/microsoft/Security-101/blob/main/7.2%20Data%20security%20capabilities.md)           | Apprenez les outils de sécurité des données – DLP, gestion des risques internes, gouvernance des données, etc.  |
| **7.3**               | [Quiz de fin de module](https://github.com/microsoft/Security-101/blob/main/7.3%20End%20of%20module%20quiz.md)                        |                                       |                                                                                                                 |
| **8.1**               | Fondamentaux de la sécurité de l'IA     | [Concepts clés de la sécurité de l'IA](https://github.com/microsoft/Security-101/blob/main/8.1%20AI%20security%20key%20concepts.md)          | Apprenez les différences et similitudes entre la sécurité traditionnelle et la sécurité de l'IA.               |
| **8.2**               | Fondamentaux de la sécurité de l'IA     | [Capacités de sécurité de l'IA](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | Apprenez les outils de sécurité de l'IA et les contrôles qui peuvent être utilisés pour sécuriser l'IA.         |
| **8.3**               | Fondamentaux de la sécurité de l'IA     | [IA responsable](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | Apprenez ce qu'est l'IA responsable et les préjudices spécifiques à l'IA que les professionnels de la sécurité doivent connaître. |
