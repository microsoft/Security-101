...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T22:59:50+00:00",
...
# 🚀 An ninh mạng cho người mới bắt đầu – chương trình học

Trong thời đại công nghệ AI phát triển nhanh chóng, việc hiểu cách bảo vệ hệ thống CNTT trở nên quan trọng hơn bao giờ hết. Khóa học này được thiết kế để dạy bạn các khái niệm cơ bản về an ninh mạng, giúp bạn bắt đầu hành trình học tập về bảo mật. Khóa học không phụ thuộc vào nhà cung cấp và được chia thành các bài học nhỏ, mỗi bài mất khoảng 30-60 phút để hoàn thành. Mỗi bài học đều có bài kiểm tra nhỏ và liên kết đến tài liệu đọc thêm nếu bạn muốn tìm hiểu sâu hơn về chủ đề.

![Cybersecurity for Beginners](../../translated_images/banner.cc5b05d7e5deed065123ba68678b48cbbfe411cb264c09cec64f58eda064a28a.vi.jpg)
...
- 🌐 Hiểu về mô hình zero trust và tại sao nó quan trọng trong an ninh mạng hiện đại.
...
|-------------------|-------------------------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------|  
| **1.1**           | Các khái niệm cơ bản về bảo mật                   | [Tam giác CIA](https://github.com/microsoft/Security-101/blob/main/1.1%20The%20CIA%20triad%20and%20other%20key%20concepts.md)                        | Tìm hiểu về tính bảo mật, tính khả dụng và tính toàn vẹn. Cũng như tính xác thực, không thể chối bỏ và quyền riêng tư. |  
| **1.2**           | Các khái niệm cơ bản về bảo mật                   | [Các mối đe dọa an ninh mạng phổ biến](https://github.com/microsoft/Security-101/blob/main/1.2%20Common%20cybersecurity%20threats.md)        | Tìm hiểu về các mối đe dọa an ninh mạng phổ biến đối với cá nhân và tổ chức.                             |  
...
| **1.4**           | Các khái niệm cơ bản về bảo mật                   | [Thực hành và tài liệu bảo mật](https://github.com/microsoft/Security-101/blob/main/1.4%20Security%20practices%20and%20documentation.md) | Tìm hiểu về sự khác biệt giữa chính sách, quy trình, tiêu chuẩn và quy định/luật pháp.                         |  
...
| **2.1**           | Các nguyên tắc cơ bản về quản lý danh tính và truy cập | [Các khái niệm chính về IAM](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | Tìm hiểu về nguyên tắc quyền tối thiểu, phân tách nhiệm vụ, cách IAM hỗ trợ zero trust.               |  
| **2.2**           | Các nguyên tắc cơ bản về quản lý danh tính và truy cập | [Kiến trúc zero trust IAM](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Tìm hiểu về cách danh tính trở thành ranh giới mới cho môi trường CNTT hiện đại và các mối đe dọa mà nó giảm thiểu.          |  
| **2.3**           | Các nguyên tắc cơ bản về quản lý danh tính và truy cập | [Các khả năng của IAM](https://github.com/microsoft/Security-101/blob/main/2.3%20IAM%20capabilities.md)                     | Tìm hiểu về các khả năng và biện pháp kiểm soát của IAM để bảo vệ danh tính                                                  |  
...
| **4.1**           | Các nguyên tắc cơ bản về hoạt động bảo mật          | [Các khái niệm chính về SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | Tìm hiểu về tại sao hoạt động bảo mật quan trọng và cách nó khác biệt với các nhóm vận hành CNTT thông thường.                  |  
...
| **6.1**           | Các nguyên tắc cơ bản về bảo mật cơ sở hạ tầng      | [Các khái niệm chính về bảo mật cơ sở hạ tầng](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | Tìm hiểu về việc củng cố hệ thống, vá lỗi, vệ sinh bảo mật, bảo mật container.                                  |  
| **6.2**           | Các nguyên tắc cơ bản về bảo mật cơ sở hạ tầng      | [Các khả năng bảo mật cơ sở hạ tầng](https://github.com/microsoft/Security-101/blob/main/6.2%20Infrastructure%20security%20capabilities.md) | Tìm hiểu về các công cụ hỗ trợ bảo mật cơ sở hạ tầng như CSPM, bảo mật container, v.v.            |  
| **6.3**           | [Bài kiểm tra cuối mô-đun](https://github.com/microsoft/Security-101/blob/main/6.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
| **7.1**           | Các nguyên tắc cơ bản về bảo mật dữ liệu                | [Các khái niệm chính về bảo mật dữ liệu](https://github.com/microsoft/Security-101/blob/main/7.1%20Data%20security%20key%20concepts.md)           | Tìm hiểu về phân loại và lưu giữ dữ liệu và tại sao điều này quan trọng đối với tổ chức.                     |  
| **7.2**           | Các nguyên tắc cơ bản về bảo mật dữ liệu                | [Các khả năng bảo mật dữ liệu](https://github.com/microsoft/Security-101/blob/main/7.2%20Data%20security%20capabilities.md)           | Tìm hiểu về các công cụ bảo mật dữ liệu – DLP, quản lý rủi ro nội bộ, quản trị dữ liệu, v.v.                          |  
| **7.3**           | [Bài kiểm tra cuối mô-đun](https://github.com/microsoft/Security-101/blob/main/7.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
...
| **8.2**           | Các nguyên tắc cơ bản về bảo mật AI                | [Các khả năng bảo mật AI](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | Tìm hiểu về các công cụ bảo mật AI và các biện pháp kiểm soát có thể được sử dụng để bảo vệ AI.                          |  
...
| **8.4**           | [Bài kiểm tra cuối mô-đun](https://github.com/microsoft/Security-101/blob/main/8.4%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
