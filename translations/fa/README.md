...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-12T08:50:35+00:00",
...
[![مشکلات یا درخواست‌های کشش GitHub](https://img.shields.io/github/issues/microsoft/Security-101)](https://github.com/microsoft/Security-101/issues)
...
> 💁 اگر بازخورد یا پیشنهادی درباره این دوره دارید و فکر می‌کنید محتوایی جا افتاده است، خوشحال می‌شویم از شما بشنویم!
...
| **4.1**           | اصول عملیات امنیتی          | [مفاهیم کلیدی SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | یادگیری درباره اینکه چرا عملیات امنیتی مهم است و چگونه با تیم‌های عملیات فناوری اطلاعات معمولی تفاوت دارد.                  |
