...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-12T09:04:07+00:00",
...
| **1.3**           | Βασικές έννοιες ασφάλειας                   | [Κατανόηση της διαχείρισης κινδύνων](https://github.com/microsoft/Security-101/blob/main/1.3%20Understanding%20risk%20management.md)       | Μάθετε για την αξιολόγηση και την κατανόηση του κινδύνου – επίπτωση/πιθανότητα και την εφαρμογή μέτρων.                                                                                                               | |
