...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T19:50:07+00:00",
...
Σε αυτήν την εποχή της ταχείας υιοθέτησης της τεχνολογίας AI, είναι ακόμα πιο κρίσιμο να κατανοήσουμε πώς να προστατεύουμε τα συστήματα πληροφορικής. Αυτό το μάθημα έχει σχεδιαστεί για να σας διδάξει βασικές έννοιες κυβερνοασφάλειας, ώστε να ξεκινήσετε την εκμάθηση της ασφάλειας. Είναι ανεξάρτητο από προμηθευτές και χωρίζεται σε μικρά μαθήματα που απαιτούν περίπου 30-60 λεπτά για να ολοκληρωθούν. Κάθε μάθημα περιλαμβάνει ένα μικρό κουίζ και συνδέσμους για περαιτέρω ανάγνωση, αν θέλετε να εμβαθύνετε περισσότερο στο θέμα.  

![Cybersecurity for Beginners](../../translated_images/banner.cc5b05d7e5deed065123ba68678b48cbbfe411cb264c09cec64f58eda064a28a.el.jpg)  
...
[![Watch the video](../../translated_images/intro_placeholder.f42382df518f233a1ea3cb1c82ae8f92732bc3ac4ac2b3138cb561d24ca91df5.el.png)](https://learn-video.azurefd.net/vod/player?id=a0fe1cef-c064-4d59-97a9-e89e12a99b4d)  
...
> 💁 Αν έχετε οποιαδήποτε σχόλια ή προτάσεις για αυτό το μάθημα και οποιοδήποτε περιεχόμενο που λείπει, θα χαρούμε να ακούσουμε από εσάς!  
...
| **1.3**           | Βασικές έννοιες ασφάλειας                   | [Κατανόηση της διαχείρισης κινδύνων](https://github.com/microsoft/Security-101/blob/main/1.3%20Understanding%20risk%20management.md)       | Μάθετε για την αξιολόγηση και την κατανόηση του κινδύνου – επίπτωση/πιθανότητα και την εφαρμογή μέτρων ασφαλείας.                                                                                                               | |  
...
| **2.1**           | Θεμελιώδεις αρχές διαχείρισης ταυτότητας και πρόσβασης | [Βασικές έννοιες IAM](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | Μάθετε για την αρχή της ελάχιστης προνομιακής πρόσβασης, τον διαχωρισμό καθηκόντων, πώς το IAM υποστηρίζει το zero trust.               |  
| **2.2**           | Θεμελιώδεις αρχές διαχείρισης ταυτότητας και πρόσβασης | [Αρχιτεκτονική zero trust IAM](https://github.com/microsoft/Security-101/blob/main/2.2%20IAM%20zero%20trust%20architecture.md)          | Μάθετε πώς η ταυτότητα είναι το νέο περίγραμμα για σύγχρονα περιβάλλοντα IT και τις απειλές που αντιμετωπίζει.          |  
| **2.3**           | Θεμελιώδεις αρχές διαχείρισης ταυτότητας και πρόσβασης | [Δυνατότητες IAM](https://github.com/microsoft/Security-101/blob/main/2.3%20IAM%20capabilities.md)                     | Μάθετε για τις δυνατότητες και τα μέτρα ασφαλείας IAM για την προστασία ταυτοτήτων.                                                  |  
...
| **4.1**           | Θεμελιώδεις αρχές λειτουργιών ασφαλείας          | [Βασικές έννοιες SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | Μάθετε γιατί οι λειτουργίες ασφαλείας είναι σημαντικές και πώς διαφέρουν από τις κανονικές ομάδες λειτουργιών IT.                  |  
...
| **5.2**           | Θεμελιώδεις αρχές ασφάλειας εφαρμογών         | [Δυνατότητες AppSec](https://github.com/microsoft/Security-101/blob/main/5.2%20AppSec%20key%20capabilities.md)                  | Μάθετε για εργαλεία AppSec: εργαλεία ασφάλειας pipeline, σάρωση κώδικα, σάρωση μυστικών κ.λπ.                       |  
| **5.3**           | [Κουίζ τέλους ενότητας](https://github.com/microsoft/Security-101/blob/main/5.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
| **6.1**           | Θεμελιώδεις αρχές ασφάλειας υποδομής      | [Βασικές έννοιες ασφάλειας υποδομής](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | Μάθετε για την ενίσχυση συστημάτων, την εφαρμογή ενημερώσεων, την υγιεινή ασφάλειας, την ασφάλεια κοντέινερ.                                  |  
| **6.2**           | Θεμελιώδεις αρχές ασφάλειας υποδομής      | [Δυνατότητες ασφάλειας υποδομής](https://github.com/microsoft/Security-101/blob/main/6.2%20Infrastructure%20security%20capabilities.md) | Μάθετε για εργαλεία που μπορούν να βοηθήσουν στην ασφάλεια υποδομής, π.χ. CSPM, ασφάλεια κοντέινερ κ.λπ.            |  
| **6.3**           | [Κουίζ τέλους ενότητας](https://github.com/microsoft/Security-101/blob/main/6.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
| **7.1**           | Θεμελιώδεις αρχές ασφάλειας δεδομένων                | [Βασικές έννοιες ασφάλειας δεδομένων](https://github.com/microsoft/Security-101/blob/main/7.1%20Data%20security%20key%20concepts.md)           | Μάθετε για την ταξινόμηση και τη διατήρηση δεδομένων και γιατί είναι σημαντικά για έναν οργανισμό.                     |  
| **7.2**           | Θεμελιώδεις αρχές ασφάλειας δεδομένων                | [Δυνατότητες ασφάλειας δεδομένων](https://github.com/microsoft/Security-101/blob/main/7.2%20Data%20security%20capabilities.md)           | Μάθετε για εργαλεία ασφάλειας δεδομένων – DLP, διαχείριση εσωτερικών κινδύνων, διακυβέρνηση δεδομένων κ.λπ.                          |  
| **7.3**           | [Κουίζ τέλους ενότητας](https://github.com/microsoft/Security-101/blob/main/7.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |  
| **8.1**           | Θεμελιώδεις αρχές ασφάλειας AI                | [Βασικές έννοιες ασφάλειας AI](https://github.com/microsoft/Security-101/blob/main/8.1%20AI%20security%20key%20concepts.md)          | Μάθετε για τις διαφορές και τις ομοιότητες μεταξύ παραδοσιακής ασφάλειας και ασφάλειας AI.                 |  
| **8.2**           | Θεμελιώδεις αρχές ασφάλειας AI                | [Δυνατότητες ασφάλειας AI](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | Μάθετε για εργαλεία ασφάλειας AI και τα μέτρα που μπορούν να χρησιμοποιηθούν για την προστασία AI.                         |  
| **8.3**           | Θεμελιώδεις αρχές ασφάλειας AI                | [Υπεύθυνη AI](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | Μάθετε τι είναι η υπεύθυνη AI και τις συγκεκριμένες βλάβες AI που πρέπει να γνωρίζουν οι επαγγελματίες ασφάλειας.                          |  
| **8.4**           | [Κουίζ τέλους ενότητας](https://github.com/microsoft/Security-101/blob/main/8.4%20End%20of%20module%20quiz.md)     
...
- [Κατανόηση του GitHub Copilot για Συνεργατική Προγραμματιστική](https://github.com/microsoft/Mastering-GitHub-Copilot-for-Paired-Programming)  
